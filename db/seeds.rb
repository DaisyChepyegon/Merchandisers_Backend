...
mer = Merchandiser.create(username: "Kyle M. Miller", image: "https://images.unsplash.com/photo-1616002411355-49593fd89721?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cGFzc3BvcnQlMjBwaG90b3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60", email: "kyle@gmail.com", phone_number: 712000000,  password_digest: "123", location: "Ngara", route_plan_id:1)
merc =Merchandiser.create(username: "Laura K. Dean", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cGVvcGxlJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=60", email: "laura@gmail.com", phone_number: 734000000, password_digest: "1234", location: "Pangani", route_plan_id:2)
merch =Merchandiser.create(username: "Jason A. Woods", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cGVvcGxlJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=60", email: "jason@gmail.com", phone_number: 756000000, password_digest: "12345", location: "Embakasi", route_plan_id:2)
mercha =Merchandiser.create(username: "Jasmine Hogan", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cGVvcGxlJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=60", email: "jasmine@gmail.com", phone_number: 778000000,  password_digest: "123456", location: "Karen", route_plan_id:3)
...
puts "seeding outlet"
ou =Outlet.create(name: "Naivas Moi Avenue", location:"Development House, Moi Avenue", merchandiser_id: 1, route_plan_id:1 )
out =Outlet.create(name: "Carrefour Mega", location:"Carrefour Mega", merchandiser_id: 1, route_plan_id:1)
outl =Outlet.create(name: "Chandarana Foodplus Supermarkets Ngara", location:"Parklands/Highridge", merchandiser_id: 2, route_plan_id:2)
outle =Outlet.create(name: "Mathai Supermarket Ltd", location:"Ronald Ngala St · In NNUS Bus Service", merchandiser_id: 2, route_plan_id:2)

puts "seeding routeplan"
rou =RoutePlan.create(name: "routeA", month: "Jan")
rout =RoutePlan.create(name: "routeB", month: "Feb")
route =RoutePlan.create(name: "routeC", month: "March")
routep =RoutePlan.create(name: "routeD", month: "April")
